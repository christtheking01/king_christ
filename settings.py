...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'christ_king_church.context_processors.notification_counts_context',
            ],
        },
    },
]
...
# POS Backend Printing Configuration
# Enable backend printing for POS systems without browser print dialog (e.g., H10 POS)
POS_BACKEND_PRINTING_ENABLED = True  # Force enable for H10 POS
# Printer name for CUPS (Linux) or Windows
POS_PRINTER_NAME = os.getenv('POS_PRINTER_NAME', 'default')
# Direct device path for USB/Serial printers (e.g., '/dev/usb/lp0' or 'COM1')
POS_PRINTER_DEVICE = os.getenv('POS_PRINTER_DEVICE', '/dev/usb/lp0')
